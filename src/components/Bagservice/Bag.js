...
const Bag = () => {
    ...
    const getbrands = async () => {
        let result = await fetch(apiUrl("getbagbrand"));
    ...
    const collectData = async () => {
        ...
        if (brand == "") {
            ...
            let result = await fetch(apiUrl("bagadd"),
                {
                    method: "post",
                    body: fd,
                });
            ...
            console.log(result)
            if (result._id != "") {
                sessionStorage.setItem("bagenquiryid", result._id)
        ...
        <>
            ...
            <Container>
                <Form className="watch_datas">
                    <h3 class="our_services_watch">Luxury Bag</h3>
                    <Row className="mb-5 mt-4">
                        ...
                        <div className="col-lg-4">
                            ...
                            >Product Purchased Year</Form.Label>
                            <Form.Select aria-label="Default select example"
                                value={year}
                                onChange={(e) =>
                        ...
                        <div className="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    />
                                    <label title="" for="inline-checkbox-3" class="form-check-label">Dust Jacket</label>
                                </div>
                            </div>
                        </div>
