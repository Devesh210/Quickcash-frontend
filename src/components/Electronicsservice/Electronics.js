...
const Electronics = () => {
    ...
    const getbrands = async () => {
        let result = await fetch(apiUrl("getelectronicsbrand"));
    ...
    const collectData = async () => {
        ...
        if (brand == "") {
            ...
            let result = await fetch(apiUrl("electronicsadd"),
                {
                    method: "post",
                    body: fd,
                });
            ...
            console.log(result)
            if (result._id != "") {
                sessionStorage.setItem("electronicsenquiryid", result._id)
    ...
    function ValidateEmail(e) {
        ...
        if (reg.test(emailInput.current.value) == false) {
            ...
            swal('Invalid Email Address', "warning", "warning")
        ...
        <>
            ...
            <Container>
                <Form className="watch_datas">
                    <h3 class="our_services_watch">Electronics Gadgets</h3>
